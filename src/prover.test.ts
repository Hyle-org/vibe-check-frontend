...
test(
    ...
    async () => {
        ...
        noirInput.challenge = [
            77, 68, 69, 121, 77, 122, 81, 49, 78, 106, 99, 52, 79, 87, 70, 105, 89, 50, 82, 108, 90, 106, 65, 120, 77,
            106, 77, 48, 78, 84, 89, 51, 79, 68, 108, 104, 89, 109, 78, 107, 90, 87, 89,
        ];
        noirInput.pub_key_x = [
        ...
        noirInput.pub_key = [
            48, 89, 48, 19, 6, 7, 42, 134, 72, 206, 61, 2, 1, 6, 8, 42, 134, 72, 206, 61, 3, 1, 7, 3, 66, 0, 4, 10, 139,
            43, 102, 182, 222, 131, 127, 94, 44, 137, 46, 114, 246, 188, 198, 153, 38, 51, 220, 104, 189, 146, 100, 20,
            183, 186, 135, 40, 241, 63, 90, 248, 109, 104, 228, 138, 216, 189, 114, 45, 18, 108, 136, 174, 69, 16, 115,
            225, 68, 38, 193, 19, 153, 45, 106, 117, 46, 233, 180, 209, 239, 182, 202,
        ];

        const sign_s = BigInt(
            `0x${noirInput.signature
                .slice(32)
...
test(
    "ProveCairo",
    async () => {
        expect(await proveERC20Transfer()).toBeTruthy();
    },
    60 * 1000 * 10,
);
